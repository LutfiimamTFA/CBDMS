...
export const defaultNavItems: NavigationItem[] = [
   {
    ...
    icon: 'Inbox',
    order: 0,
    roles: ['Super Admin', 'Manager', 'Employee', 'PIC'],
    parentId: null,
    isEnabled: true,
  },
  // --- GROUP 1: PROJECTS ---
  ...
  {
    id: 'nav_social_media_board',
    label: 'nav.board',
    path: '/social-media/board',
    icon: 'LayoutGrid',
    order: 2.0,
    roles: ['Super Admin', 'Manager', 'Employee', 'PIC'],
  ...
  {
    id: 'nav_workflow_tasks',
    label: 'Task Statuses',
    path: '/admin/settings/workflow/tasks',
    icon: 'ClipboardList',
    order: 25.1,
    roles: ['Super Admin'],
    parentId: 'nav_workflow_folder',
    isEnabled: true,
  },
  {
    id: 'nav_workflow_social',
    label: 'Social Media Statuses',
    path: '/admin/settings/workflow/social',
    icon: 'Share2',
    order: 25.2,
    roles: ['Super Admin'],
    parentId: 'nav_workflow_folder',
  ...
  },
  {
    id: 'nav_workflow_web',
    label: 'Web Statuses',
    path: '/admin/settings/workflow/web',
    icon: 'Globe',
    order: 25.3,
    roles: ['Super Admin'],
    parentId: 'nav_workflow_folder',
